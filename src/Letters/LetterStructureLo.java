...
public class LetterStructureLo 
{
	...
	public static void Structure()
	{
		...
		{
			MainActivity.spriteCounter++;
			StructureDrawAnimation.scale(MainActivity.moOutLineX+30*MainActivity.spriteCounter - 200,
					MainActivity.moOutLineY-50*MainActivity.spriteCounter + 340, 
					MainActivity.spriteCounter);
		}
		else if(MainActivity.spriteCounterLimit == 9)
		{
			MainActivity.spriteCounter++;
			StructureDrawAnimation.scale(MainActivity.moOutLineX-60*MainActivity.spriteCounter +680 ,
					MainActivity.moOutLineY-20*MainActivity.spriteCounter + 180,
					MainActivity.spriteCounter);  
		}
		else if(MainActivity.spriteCounterLimit == 13)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX+140 , 
					70+MainActivity.moOutLineY+90*MainActivity.spriteCounter-1040,
					MainActivity.spriteCounter);
		}
	...
	public static void getStructure(float x, float y) 
	{
		...
		else if(MainActivity.state==4)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX +40,
					MainActivity.moOutLineY+80, MainActivity.spriteCounter); 
		...
		else if(MainActivity.state==7)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX-50*MainActivity.spriteCounter +470 ,
					MainActivity.moOutLineY-30*MainActivity.spriteCounter + 270, MainActivity.spriteCounter); 
		...
		else if(MainActivity.state==10)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX+40*MainActivity.spriteCounter -260 ,
					MainActivity.moOutLineY+50*MainActivity.spriteCounter-580, MainActivity.spriteCounter); 
