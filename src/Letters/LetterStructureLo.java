...
public class LetterStructureLo 
{
	...
	public static void Structure()
	{
		...
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX+30*GameActivity.spriteCounter - 200,
					GameActivity.moOutLineY-50*GameActivity.spriteCounter + 340, 
					GameActivity.spriteCounter);
		}
		else if(GameActivity.spriteCounterLimit == 9)
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX-60*GameActivity.spriteCounter +680 ,
					GameActivity.moOutLineY-20*GameActivity.spriteCounter + 180,
					GameActivity.spriteCounter);  
		}
		else if(GameActivity.spriteCounterLimit == 13)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX+140 , 
					70+GameActivity.moOutLineY+90*GameActivity.spriteCounter-1040,
					GameActivity.spriteCounter);
		}
	...
	public static void getStructure(float x, float y) 
	{
		...
		else if(GameActivity.state==10)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX+40*GameActivity.spriteCounter -260 ,
					GameActivity.moOutLineY+50*GameActivity.spriteCounter-580, GameActivity.spriteCounter); 
