...
public class LetterStructureToh
{
	...
	public static void createNumberSpriteAndCursor()
	{
		...
		StructureDrawAnimation.scale(GameActivity.moOutLineX + 70 - 100, GameActivity.moOutLineY -30, 1);
		...
		else if(GameActivity.state==2)
		{
			...
			else if(GameActivity.state==7)
			{
				...
				StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +500 ,
						GameActivity.moOutLineY-30*GameActivity.spriteCounter + 390, GameActivity.spriteCounter); 
			...
			else if(GameActivity.state==9)
			{
				...
				if(
						 GameActivity.whiteChalk[GameActivity.aCounter].getX() - GameActivity.posX< -55 
						 	|| GameActivity.whiteChalk[GameActivity.aCounter].getX() - GameActivity.posX>50 
							|| GameActivity.whiteChalk[GameActivity.aCounter].getY() - GameActivity.posY>60 
							|| GameActivity.whiteChalk[GameActivity.aCounter].getY() - GameActivity.posY<-85 
						)
				{
			...
			else if(GameActivity.state==10)
			{
				...
				StructureDrawAnimation.scale(GameActivity.moOutLineX+40*GameActivity.spriteCounter -270 ,
						GameActivity.moOutLineY+50*GameActivity.spriteCounter-530, GameActivity.spriteCounter); 
...
//				NumberSprites.setCursorPosition(MainActivity.numberSprites[9]);
	...
	public static void Structure()
	{
		...
		else if(GameActivity.spriteCounterLimit == 7)
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX+10 ,
					GameActivity.moOutLineY+90*GameActivity.spriteCounter - 460,
					GameActivity.spriteCounter);
		}
		else if(GameActivity.spriteCounterLimit == 9)
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +540 ,
					GameActivity.moOutLineY-30*GameActivity.spriteCounter + 320,
					GameActivity.spriteCounter);
		}
		else if(GameActivity.spriteCounterLimit == 12)
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX-70*GameActivity.spriteCounter +820 ,
					GameActivity.moOutLineY-50*GameActivity.spriteCounter+460,
					GameActivity.spriteCounter);
		}
