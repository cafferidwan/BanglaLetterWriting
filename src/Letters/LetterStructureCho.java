...
public class LetterStructureCho 
{
	...
	public static void Structure()
	{
		...
		else if(GameActivity.spriteCounterLimit == 7)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX+20 ,
					GameActivity.moOutLineY+100*GameActivity.spriteCounter - 540,
					GameActivity.spriteCounter);
		}
		else if(GameActivity.spriteCounterLimit == 9)
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +570 ,
		...
		else if(GameActivity.spriteCounterLimit == 11)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX+10 , 
					70+GameActivity.moOutLineY-90*GameActivity.spriteCounter+880,
					GameActivity.spriteCounter);
		}
	...
	public static void getStructure(float x, float y) 
	{
		...
		else if(GameActivity.state==7)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +490 ,
					GameActivity.moOutLineY-30*GameActivity.spriteCounter + 360, GameActivity.spriteCounter); 
		...
		else if(GameActivity.state==10)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX+40*GameActivity.spriteCounter -340 ,
					GameActivity.moOutLineY+50*GameActivity.spriteCounter-480, GameActivity.spriteCounter); 
