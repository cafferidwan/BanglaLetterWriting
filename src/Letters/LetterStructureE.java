	...
	public static void Structure()
	{
		...
		else if(MainActivity.spriteCounterLimit == 12)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX-80*MainActivity.spriteCounter +940 ,
					MainActivity.moOutLineY-40*MainActivity.spriteCounter+370,
					MainActivity.spriteCounter);
		}
		...
		else if(MainActivity.state==2)
		{
			...
			else if(MainActivity.state==10)
			{
				...
				StructureDrawAnimation.scale(MainActivity.moOutLineX+40*MainActivity.spriteCounter -280 ,
						MainActivity.moOutLineY+50*MainActivity.spriteCounter-520, MainActivity.spriteCounter); 
...
//				}
	...
	public static void createNumberSpriteAndCursor()
	{
		...
		StructureDrawAnimation.scale(MainActivity.moOutLineX -30, MainActivity.moOutLineY - 20, 1);
