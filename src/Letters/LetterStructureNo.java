...
public class LetterStructureNo 
{
	...
	public static void Structure()
	{
		...
		{
			GameActivity.spriteCounter++;
			StructureDrawAnimation.scale(GameActivity.moOutLineX+40*GameActivity.spriteCounter - 150 ,
					GameActivity.moOutLineY+110*GameActivity.spriteCounter - 620,
					GameActivity.spriteCounter);
		}
		else if(GameActivity.spriteCounterLimit == 9)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +580 ,
					GameActivity.moOutLineY-30*GameActivity.spriteCounter + 200,
					GameActivity.spriteCounter);   
		} 
	...
	public static void getStructure(float x, float y) 
	{
		...
		else if(GameActivity.state==7)
		{
			...
			StructureDrawAnimation.scale(GameActivity.moOutLineX-50*GameActivity.spriteCounter +530 ,
					GameActivity.moOutLineY-30*GameActivity.spriteCounter + 290, GameActivity.spriteCounter); 
