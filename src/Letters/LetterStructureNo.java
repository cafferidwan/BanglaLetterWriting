...
public class LetterStructureNo 
{
	...
	public static void Structure()
	{
		...
		{
			MainActivity.spriteCounter++;
			StructureDrawAnimation.scale(MainActivity.moOutLineX+40*MainActivity.spriteCounter - 150 ,
					MainActivity.moOutLineY+110*MainActivity.spriteCounter - 620,
					MainActivity.spriteCounter);
		}
		else if(MainActivity.spriteCounterLimit == 9)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX-50*MainActivity.spriteCounter +580 ,
					MainActivity.moOutLineY-30*MainActivity.spriteCounter + 200,
					MainActivity.spriteCounter);   
		} 
	...
	public static void getStructure(float x, float y) 
	{
		...
		else if(MainActivity.state==7)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX-50*MainActivity.spriteCounter +530 ,
					MainActivity.moOutLineY-30*MainActivity.spriteCounter + 290, MainActivity.spriteCounter); 
