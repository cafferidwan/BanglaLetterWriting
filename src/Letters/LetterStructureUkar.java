...
public class LetterStructureUkar
{
	...
	public static void Structure()
	{
		...
		if(MainActivity.spriteCounterLimit == 3)
		{
			...
			StructureDrawAnimation.scale(MainActivity.moOutLineX-50*MainActivity.spriteCounter + 160, 
		...
		{
			MainActivity.spriteCounter++;
			StructureDrawAnimation.scale(MainActivity.moOutLineX+80*MainActivity.spriteCounter - 360 ,
					MainActivity.moOutLineY+50*MainActivity.spriteCounter - 220,
					MainActivity.spriteCounter);
		}
	}
